...
Or from project root:
    .venv/bin/python services/mcp_server/install_to_claude.py
...
def get_project_root() -> Path:
    ...
    # This script is at: services/mcp_server/install_to_claude.py
...
def get_api_key() -> str:
    """Read API key from local_key.txt."""
    # Try development path first (runtime/local_rag/)
...
def main():
    ...
    if not api_key:
        ...
        print(f"Expected key location: {get_data_dir() / 'local_key.txt'}")
        print()
