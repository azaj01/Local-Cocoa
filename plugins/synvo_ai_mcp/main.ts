/**
 * MCP Plugin - Main Process Entry Point
 * Registers IPC handlers for MCP (Model Context Protocol) functionality
 * Initializes MCP server for Claude Desktop integration
 */
